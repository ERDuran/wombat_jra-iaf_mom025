...
temp_anom = nc_fid.variables['temp'][:,:,56,:]

# get dimensions
lat = nc_fid.variables['yt_ocean'][56]
...
for y in years:
    ...
    # filled contour plot
    contf = plt.contourf(lon, -z, temp_anom[idx,:,:], contf_lvls, 
                         cmap=cmap, extend='both')
    
    # title ...
    ax.set_title('lat=' + str(round(lat)) + '$^{\circ}S $ ' + str(y))
