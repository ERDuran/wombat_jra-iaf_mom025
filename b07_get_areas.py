...
# Saving the objects:
with open('areas.pkl', 'w') as f:  # Python 3: open(..., 'wb')
    pickle.dump(\
                [lon_EAC_ext, lat_EAC_ext, lon_EAC_sep, lat_EAC_sep, \
                 lon_south_LC, lat_south_LC, lon_LCE, lat_LCE], f)
...
for y in years[19:20]:
    ...
    # filled contour plot
    contf = Bm.contourf(Bm_lons, Bm_lats, temp_anom[idx,:,:], 
